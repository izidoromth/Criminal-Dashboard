...
df = pd.read_csv('./data/gmc/sigesguarda.csv', delimiter=';', encoding='ISO-8859-1')
...
df['ATENDIMENTO_BAIRRO_NOME'] = df['ATENDIMENTO_BAIRRO_NOME'].str.normalize('NFKD').str.encode('ascii', errors='ignore').str.decode('utf-8')

df.to_csv('./data/gmc/sigesguarda_cleaned.csv', index=False)
