...
df = pd.read_csv('./sigesguarda.csv', delimiter=';', encoding='ISO-8859-1')
...
df.to_csv('sigesguarda_cleaned.csv', index=False)

f = open('./DIVISA_DE_BAIRROS.geojson',)
...
geojsondf.to_file('divisa_bairros_cleaned.geojson', driver="GeoJSON")  